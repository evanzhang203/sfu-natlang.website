...
* "TroFi Example Base":http://www.cs.sfu.ca/~anoop/students/jbirke/Presentation_EACL06.ppt
...
augmentation run are given next. (See ("Birke, 2005":http://www.cs.sfu.ca/~anoop/students/jbirke/jbirke_thesis.pdf))
